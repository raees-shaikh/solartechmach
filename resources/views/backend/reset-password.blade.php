...
<head>
    ...
    <link rel="icon" href="{{asset('frontend/assets/img/circle.jpg')}}" type="image/png">
    <title>Reset Password - Solar Techmach</title>
    ...
    <style>
        ...
        .body-bg {
            background: linear-gradient(180deg, rgba(0, 175, 239, 0.0145) 0%, #145D94 100%) !important;
