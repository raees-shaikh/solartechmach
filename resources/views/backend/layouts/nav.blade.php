  ...
  <div class="header-container fixed-top">
      <header class="header navbar navbar-expand-sm">
          ...
          <ul class="navbar-nav theme-brand flex-row  text-center">
              ...
              <li class="nav-item theme-text w-auto">
                  <a href="/" class="nav-link">
                      {{-- FACE RECOG --}}
                      <img src="{{ asset('/frontend/assets/img/solar-logo.jpg') }}" class="rounded navbar-logo img-fluid"
          ...
          <div class="d-lg-none d-block m-0 p-0">
              <a href="{{ url('/') }}">
                  <img src="{{ asset('frontend/assets/img/solar-logo.jpg') }}" class="navbar-logo  my-2 p-0  img-fluid"
                      alt="logo" style="width: 120px">
              </a>
          </div>
                    ...
                    <a href="{{ route('cms.product.index') }}"
                        ...
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512">
                                <path d="M160 128V96C160 43 203 0 256 0s96 43 96 96v32h32c35.3 0 64 28.7 64 64V448c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V192c0-35.3 28.7-64 64-64h32zm32 0h128V96c0-26.5-21.5-48-48-48s-48 21.5-48 48v32z"/>
                            </svg>
                            <span>Products</span>
                        </div>
                    </a>
