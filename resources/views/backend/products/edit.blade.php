                        ...
                        <form class="mt-3" method="POST" action="{{ route('cms.product.update', $product->id) }}"
                            ...
                            <div class="form-group mb-3 row">
                                ...
                                <div class="col-12 px-3 mt-2">
                                    ...
                                    <textarea placeholder="enter the description" id="team-about" name="description" minlength="3" maxlength="50000">{{ old('description', json_decode($product->description)) }}</textarea>
